...
const Hero = () => {
  ...
  return (
    ...
    >
      <section className="w-full lg:w-1/2 mx-auto px-8 flex flex-col md:h-full justify-center gap-2">
        ...
        with hands-on experience in remote software development. I've built scalable <a href="https://drive.google.com/file/d/1UNninKfbEY3o9QiSTstYagHJwaL7ITzo/view?usp=drive_link" className="text-red-400 hover:text-red-600">Web Application</a> for a governmental organization, excelled in my <a href="https://drive.google.com/file/d/1YnPsy89JXayNF4c7nuTMg1fywsmzFMqW/view?usp=drive_link" className="text-red-400 hover:text-red-600">Computer Engineering Degree</a>, and polished my skills at <a href="https://drive.google.com/file/d/13vZ9FqHuxbYWAjOH1ddba4agLXrrve-K/view?usp=drive_link" className="text-red-400 hover:text-red-600">Microverse</a>. I'd love to discuss how I can bring my expertise to your team. <a href="mailto:fevenseyfu00@gmail.com" className="text-red-400 hover:text-red-600">Get in Touch!</a>
        </p>
        ...
        <div className="flex fle-row gap-2 md:gap-4 lg:gap-12 items-center text-base lg:text-xl">
            ...
            <a href="https://drive.google.com/file/d/1RAFSlRP88BpNChu9Ns5iYck7wCgalOAu/view?usp=drive_link" className="text-white border-2 px-3 md:px-6 py-1 md:py-3 my-2 flex items-center rounded-md hover:bg-red-600 hover:border-red-600">
              Get Resume 
            </a>
