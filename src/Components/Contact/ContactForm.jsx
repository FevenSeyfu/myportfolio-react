...
const ContactForm = () => {
  ...
  return (
    ...
    >
      ...
      <button
        className="text-white font-bold rounded-lg border-2 hover:bg-primary-dark-red hover:border-primary-dark-red px-4 py-3 mb-8 md:mb-12 outline-primary-dark-red disabled:cursor-not-allowed disabled:bg-gray-700 disabled:border-gray-800"
