...
const Contact = () => {
  ...
  return (
    <section
      name="contact"
      className="w-full pt-24 bg-primary-dark-blue flex flex-col  justify-start md:flex-row gap-2 md:gap-2 md:items-start md:justify-center md:pr-12 lg:pr-[5%]"
    ...
    >
      <div className="md:w-1/2">
        ...
        <p className="text-gray-300 pt-4 md:pt-8">
